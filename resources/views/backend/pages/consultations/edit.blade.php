...
<div class="container-xxl">
    ...
    <div class="row align-item-center">
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('backend.consultations.update', $consultation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="consultation_name" name="consultation_name" required placeholder="Enter consultation name..." value="{{ old('consultation_name', $consultation->consultation_name) }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="5" required placeholder="Enter consultation content...">{{ old('content', $consultation->content) }}</textarea>
                                @error('content')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="price" name="price" step="0.01" min="0" required placeholder="0.00" value="{{ old('price', $consultation->price) }}">
                                @error('price')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="time" name="time" min="1" required placeholder="30" value="{{ old('time', $consultation->time) }}">
                                @error('time')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
